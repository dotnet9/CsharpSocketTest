...
public class MainViewModel : BindableBase
{
    ...
    private IAsyncCommand? _refreshAllCommand;
    ...
    ///     刷新数据
    /// </summary>
    public IAsyncCommand RefreshAllCommand => _refreshAllCommand ??= new AsyncDelegateCommand(
    ...
    private Task HandleRefreshAllCommand()
    {
        if (!TcpHelper.IsRunning)
        {
            Logger.Error("未连接Tcp服务，无法发送命令");
